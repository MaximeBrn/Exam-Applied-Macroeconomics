...
%     set_param_value('SIGEXE',SIGEXE_vec(h));
    ...
    stoch_simul(M_,options_,oo_,{'E_GY','E_PHI','E_GG','E_GIG'}); % Store output, inflation and government variable responses
...
%% Build Figure 5, Figure 6,Table 5, Table 6 -> investment shock
...
writetable(Q1_G,'Tables_34_multipliers_noNWRnoLAC.xlsx','Sheet','SR','Range','C3')
writetable(Q2_G,'Tables_34_multipliers_noNWRnoLAC.xlsx','Sheet','SR','Range','F3')
writetable(Q3_G,'Tables_34_multipliers_noNWRnoLAC.xlsx','Sheet','SR','Range','I3')
writetable(Q4_G,'Tables_34_multipliers_noNWRnoLAC.xlsx','Sheet','SR','Range','L3')

writetable(Q8_G,'Tables_34_multipliers_noNWRnoLAC.xlsx','Sheet','LR','Range','C3')
writetable(Q12_G,'Tables_34_multipliers_noNWRnoLAC.xlsx','Sheet','LR','Range','F3')
writetable(Q16_G,'Tables_34_multipliers_noNWRnoLAC.xlsx','Sheet','LR','Range','I3')
writetable(Q20_G,'Tables_34_multipliers_noNWRnoLAC.xlsx','Sheet','LR','Range','L3')

%% Build Figure 7, Figure 8,Table 7, Table 8 -> investment shock (noNWRnoLAC)
...
figure ('Name','Gov. investment fiscal multipliers')
subplot(2,1,1)
f_plot_with_CI(t_small,fm_GI_mean(1:horizon),fm_GI_CI_lower(1:horizon),fm_GI_CI_upper(1:horizon),"Period gov. investment multiplier (noNWRnoLAC) : $$fm_t$$","Latex",0)

subplot(2,1,2)
f_plot_with_CI(t_small,FM_GI_mean(1:horizon),FM_GI_CI_lower(1:horizon),FM_GI_CI_upper(1:horizon),"Cumulative gov. investment multiplier (noNWRnoLAC) : $$FM_t$$","Latex",0)
