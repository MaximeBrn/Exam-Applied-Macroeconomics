...
subplot(2,1,1) % Output growth
f_plot_with_CI(t,Y_mean,Y_CI_lower,Y_CI_upper,"$$(Y_t-Y_t^{SS})/Y_0^{SS}$$","Latex",1)

subplot(2,1,2) % Inflation
f_plot_with_CI(t,Infl_mean,Infl_CI_lower,Infl_CI_upper,"$$\pi_t- \pi_t^{SS}$$","Latex",1)
...
subplot(2,1,1)
f_plot_with_CI(t_small,fm_mean(1:horizon),fm_CI_lower(1:horizon),fm_CI_upper(1:horizon),"Period gov. consumption multiplier (noNWRnoLAC)","none",0)

subplot(2,1,2)
f_plot_with_CI(t_small,FM_mean(1:horizon),FM_CI_lower(1:horizon),FM_CI_upper(1:horizon),"Cumulative gov. consumption multiplier (noNWRnoLAC)","none",0)
...
subplot(2,1,1)
f_plot_with_CI(t_small,fm_mean(1:horizon),fm_CI_lower(1:horizon),fm_CI_upper(1:horizon),"Period gov. investment multiplier","none",0)

subplot(2,1,2)
f_plot_with_CI(t_small,FM_mean(1:horizon),FM_CI_lower(1:horizon),FM_CI_upper(1:horizon),"Cumulative gov. investment multiplier","none",0)
